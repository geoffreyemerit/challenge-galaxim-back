...
public class JwtService {
    ...
    /* J'appelle une méthode générique "extractClaim" et je lui demande de m'extraire 'get subject', c'est-à-dire username */
    ...
    /* Event if we use user email for storing a unique user in DB, for Spring Framework, it will be named "userEmail" */
